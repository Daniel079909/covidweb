        ...
        <div class="row">
            <div class="col-xs-12 col-md-6">
                <div class="container-info text-center text-md-start text-white px-5">
                    ...
                    <div class="my-2 fst-italic">Por Mario Orellana/Daniel Patiño</div>
                    <div class="my-2 fs-1 fw-bolder">Tu salud es lo más importante.</div>
                    <div class="my-2">¿Cómo funciona el test? Utilizamos una red neuronal artificial entrenada con una compilación de datos publica del INS ( Instituto Nacionale de Salud ) del pais de Mexico
                        que contiene casos reales de personas que lamentablemente padecieron la enfermedad de COVID-19. Posteriormente te ofrecemos una predicción de tu riesgo de mortalidad.</div>
